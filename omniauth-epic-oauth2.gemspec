...
Gem::Specification.new do |gem|
  ...
  gem.summary       = %q{An Epic OAuth2 strategy for OmniAuth.}
  gem.description   = %q{An Epic OAuth2 strategy for OmniAuth. This allows you to login to Epic Games with your ruby app.}
